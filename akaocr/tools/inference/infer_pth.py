...
This file contains infer pipeline of whole model, format torch pth
_____________________________________________________________________________
"""
import sys
sys.path.append("../../")
...
def test_pipeline(args):
    ...
    deteclayer = Detectlayer(model_name="test", model_format=args.model_format)
...
def main():
    ...
    parser.add_argument('--model_format', type=str, default='pth', required=False, help='model format to infer (pth/onnx), default=pth')
