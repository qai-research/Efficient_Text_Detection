...
This file contains evaluation methods for detec model
_____________________________________________________________________________
"""
...
class Evaluate:
    ...
    def evaluate_method(self, evaluationParams):        
        """
    ...
    def main_evaluation(self,p,default_evaluation_params_fn,evaluate_method_fn,show_result=True,per_sample=True):
